...
Original file is located at
    https://colab.research.google.com/drive/1mo471NktZqLqNpg3qOG6q_2lFW-Xz0aI
"""
...
def ConvNeXt(
    ...
    # カーネルサイズを4から12に変更
    nn = conv2d_no_bias(inputs, stem_width, kernel_size=12, strides=4, padding="VALID", use_bias=True, name="stem_")
  ...
  #カーネルサイズを２から6に変更
            nn = conv2d_no_bias(nn, out_channel, kernel_size=6, strides=2, use_bias=True, name=stack_name + "downsample_")
